        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden bg-surface shadow-2xl shadow-blue-500/10 border border-border/50">
              ...
              <div className={`absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent transition-opacity ${isVideoPlaying ? 'opacity-0 hover:opacity-100' : 'opacity-100'}`}>
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isVideoPlaying ? (
                      <Pause className="h-5 w-5 text-ink" />
                    ) : (
                  ...
                  >
                    {isVideoMuted ? (
                      <VolumeX className="h-5 w-5 text-ink" />
                    ) : (
          ...
          <div className="max-w-4xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-surface/50 rounded-xl p-4 border border-border/50 text-center">
              <div className="text-2xl font-bold text-gold mb-1">2 min</div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-xl font-bold text-ink">{advantage.stat}</div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gold-900/30 to-gold-light-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link 
              href="/crowdfunding"
              className="px-8 py-4 bg-transparent text-ink font-semibold rounded-xl hover:bg-white/10 transition border border-white/30"
            >
              Browse Projects
            </Link>
          </div>
