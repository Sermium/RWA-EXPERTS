      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-medium rounded-lg transition-colors"
          >
        ...
        {!isLoading && featuredPost && (
          <div className="mb-16">
            <Link href={`/about/blog/${featuredPost.slug}`}>
              <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 rounded-2xl overflow-hidden border border-purple-500/20 hover:border-purple-500/40 transition-all">
                <div className="grid md:grid-cols-2 gap-8 p-8">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <span className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 font-medium group">
                      Read Article
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regularPosts.map((post) => (
              <Link key={post.id} href={`/about/blog/${post.slug}`}>
                <article className="bg-gray-800/50 rounded-xl border border-gray-700/50 overflow-hidden hover:border-purple-500/50 transition-all group h-full">
