...
const ComplianceDocs = dynamic(
  () => import('../docs/compliance/page').then(mod => ({ default: mod.default })),
  { loading: () => <DocLoader />, ssr: false }
);

const DeploymentDocs = dynamic(
  () => import('../docs/deployment/page').then(mod => ({ default: mod.default })),
  { loading: () => <DocLoader />, ssr: false }
);

const IncidentResponseDocs = dynamic(
  () => import('../docs/incident-response/page').then(mod => ({ default: mod.default })),
  { loading: () => <DocLoader />, ssr: false }
);

const IntegrationDocs = dynamic(
  () => import('../docs/integration/page').then(mod => ({ default: mod.default })),
  { loading: () => <DocLoader />, ssr: false }
);

const SecurityDocs = dynamic(
  () => import('../docs/security/page').then(mod => ({ default: mod.default })),
  { loading: () => <DocLoader />, ssr: false }
);
