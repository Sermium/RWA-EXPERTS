...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-surface-sunken"><main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Link
          href="/"
          className="inline-flex items-center text-ink-muted hover:text-ink mb-8 transition-colors"
        >
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-display font-medium text-ink">Terms of Service</h1>
        ...
        <div className="prose prose-invert prose-gray max-w-none">
          <div className="bg-surface-raised/50 border border-border rounded-xl p-6 mb-8">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">3. User Accounts</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">4. Eligibility and KYC Requirements</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">5. Investment Risks</h2>
            <div className="bg-danger-muted border border-danger/30 rounded-lg p-4 mb-4">
              <p className="text-danger font-medium mb-2">Important Risk Warning</p>
              <p className="text-ink-muted text-sm">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">6. Fees and Payments</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">7. Prohibited Activities</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">8. Intellectual Property</h2>
            <p className="text-ink-muted">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">9. Limitation of Liability</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">10. Indemnification</h2>
            <p className="text-ink-muted">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">11. Dispute Resolution</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">12. Governing Law</h2>
            <p className="text-ink-muted">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">13. Changes to Terms</h2>
            <p className="text-ink-muted">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-ink mb-4">14. Contact Information</h2>
            <p className="text-ink-muted mb-4">
              If you have any questions about these Terms, please contact us:
            </p>
            <div className="bg-surface-raised rounded-lg p-4">
              <p className="text-ink-muted">Email: [CONTACT.legal]</p>
              <p className="text-ink-muted">Address: [Company Address]</p>
            </div>
          </section>
        </div>
      </main>
