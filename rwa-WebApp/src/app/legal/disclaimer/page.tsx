...
export default function DisclaimerPage() {
  return (
    <div className="min-h-screen bg-surface-sunken"><main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Warning Banner */}
        <div className="bg-danger/10 border border-danger/50 rounded-xl p-6 mb-8">
          <div className="flex items-start gap-4">
            <AlertTriangle className="w-8 h-8 text-danger flex-shrink-0" />
            <div>
              <h2 className="text-xl font-bold text-danger mb-2">Important Risk Warning</h2>
        ...
        <div className="prose prose-invert prose-gray max-w-none">
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">1. General Risk Warning</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">2. Market Risks</h2>
            <div className="space-y-4">
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Volatility Risk</h3>
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Liquidity Risk</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Valuation Risk</h3>
                <p className="text-ink-muted text-sm">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">3. Technology Risks</h2>
            <div className="space-y-4">
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Smart Contract Risk</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Blockchain Risk</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Wallet Security Risk</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-warning mb-2">Platform Risk</h3>
                <p className="text-ink-muted text-sm">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">4. Regulatory Risks</h2>
            <div className="space-y-4">
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-gold-400 mb-2">Legal and Regulatory Changes</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-gold-400 mb-2">Tax Risk</h3>
                <p className="text-ink-muted text-sm">
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-medium text-gold-400 mb-2">Compliance Risk</h3>
                <p className="text-ink-muted text-sm">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">6. Counterparty Risks</h2>
            <p className="text-ink-muted mb-4">
              Your investments may be affected by the actions or failures of various parties:
            </p>
            <ul className="list-disc list-inside text-ink-muted space-y-2 ml-4">
              <li><strong className="text-ink-muted">Issuer Risk:</strong> Asset issuers may default, mismanage assets, or fail to meet obligations</li>
              <li><strong className="text-ink-muted">Custodian Risk:</strong> Third-party custodians may face operational or financial difficulties</li>
              <li><strong className="text-ink-muted">Service Provider Risk:</strong> Failure of key service providers could impact token operations</li>
              <li><strong className="text-ink-muted">Fraud Risk:</strong> Despite our due diligence, fraudulent projects may exist</li>
            </ul>
          </section>

          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">7. No Investment Advice</h2>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">8. Investor Suitability</h2>
            <p className="text-ink-muted mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-display font-semibold text-ink mb-4">9. Acknowledgment</h2>
            <p className="text-ink-muted">
