      ...
      <div>
        ...
        <div className="flex gap-3">
            ...
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                {formData.currency === 'USD' ? '$' : formData.currency === 'EUR' ? 'â‚¬' : formData.currency === 'GBP' ? 'Â£' : ''}
            </span>
            <input
                type="text"
        ...
        {formData.estimatedValue && (
            <p className="mt-1 text-xs text-gray-500">
            {formData.currency === 'USD' ? '$' : formData.currency === 'EUR' ? 'â‚¬' : formData.currency === 'GBP' ? 'Â£' : ''}{formData.estimatedValue} {formData.currency}
            </p>
        )}
        </div>
