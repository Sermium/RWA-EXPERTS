...
export function AdminKYCDashboard() {
    ...
    return (
        <div className="bg-surface rounded-xl shadow-panel p-6">
            <h2 className="text-xl font-bold text-ink mb-6">KYC Management</h2>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-border">
                                <th className="text-left py-3 px-4 text-sm font-medium text-ink-muted">Name</th>
                                <th className="text-left py-3 px-4 text-sm font-medium text-ink-muted">Status</th>
                                <th className="text-left py-3 px-4 text-sm font-medium text-ink-muted">Level</th>
                                <th className="text-left py-3 px-4 text-sm font-medium text-ink-muted">Submitted</th>
                                <th className="text-left py-3 px-4 text-sm font-medium text-ink-muted">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {entries.map(entry => (
                                <tr key={entry.id} className="border-b border-border/60 hover:bg-surface-raised">
                                    <td className="py-3 px-4">
                                        <div className="font-medium text-ink">{entry.name}</div>
                                        <div className="text-xs text-ink-faint">{entry.id.slice(0, 8)}...</div>
                                    </td>
                                    <td className="py-3 px-4">
                    ...
                    <div className="bg-surface rounded-xl shadow-panel max-w-md w-full mx-4 p-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2 bg-green-600 text-ink rounded-lg hover:bg-green-700 disabled:opacity-50 flex items-center justify-center gap-2"
                            >
